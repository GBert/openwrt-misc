...
define KernelPackage/can-sja1000-platform
  TITLE:=NXP(Philips) SJA1000 support
  KCONFIG:=CONFIG_CAN_SJA1000_PLATFORM
  FILES:=$(LINUX_DIR)/drivers/net/can/sja1000/sja1000.ko $(LINUX_DIR)/drivers/net/can/sja1000/sja1000_platform.ko
  AUTOLOAD:=$(call AutoProbe,sja1000)
  $(call AddDepends/can)
endef

define KernelPackage/can-sja1000-platform/description
 This driver adds support for the SJA1000 chips connected to
 the "platform bus" (Linux abstraction for directly to the
 processor attached devices).  Which can be found on various
 boards from Phytec (http://www.phytec.de) like the PCM027,
 PCM038 and BananaPi. It also provides the OpenFirmware
 "platform bus" found on embedded systems with OpenFirmware
 bindings, e.g. if you have a PowerPC based system you may want
 to enable this option.
endef

$(eval $(call KernelPackage,can-sja1000-platform))
